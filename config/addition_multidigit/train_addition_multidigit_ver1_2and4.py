...
out_dir = 'out/addition_multidigit_ver1'
...
train_data_path = f'train_2and4_2000.bin' #'train_addition.bin'
val_data_path = f'val_2and4_2000.bin' #'val_addition.bin'
...
init_from = 'scratch'
ckpt_path_name = f'ckpt_2and4digit_lr{learning_rate}.pt'

wandb_log = False # override via command line if you like
wandb_entity = 'ssdd'
wandb_project = 'addition_multidigit'
wandb_run_name = f'ver1_2and4digit_lr{learning_rate}'
