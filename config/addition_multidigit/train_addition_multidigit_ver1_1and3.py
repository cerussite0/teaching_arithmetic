...
train_data_path = f'train_1and3.bin' #'train_addition.bin'
val_data_path = f'val_1and3.bin' #'val_addition.bin'
...
init_from = 'scratch'
ckpt_path_name = f'ckpt_1and3digit_lr{learning_rate}.pt'

wandb_log = False # override via command line if you like
wandb_entity = 'ssdd'
wandb_project = 'addition_multidigit'
wandb_run_name = f'ver1_1and3digit_lr{learning_rate}'
