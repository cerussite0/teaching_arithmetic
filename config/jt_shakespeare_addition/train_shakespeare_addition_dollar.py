...
out_dir = 'out-jt-shakespeare-addition'
...
wandb_entity = 'ssdd'
wandb_project = 'jt-shakespeare-addition'
wandb_run_name = 'mini-gpt-padded'

dataset = 'shakespeare_addition_dollar'
train_data_path = 'train_shakespeare.bin' #'train_addition.bin'
val_data_path = 'val_shakespeare.bin' #'val_addition.bin'

train_both = True
data_ratio = 0.5 # ratio of data_path2 compared with data_path1
train_data_path2 = 'train_addition.bin' # only used when train_both = True
val_data_path2 = 'val_addition.bin'

eval_addition = True
start = "FILE:prompt_dollar/prompt_addition_pad_test_0.0001.txt"
eval_text = True
eval_text_data_path = 'data/shakespeare_addition_dollar/val_shakespeare.bin' 
