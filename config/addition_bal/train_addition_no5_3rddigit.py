# training dataset with "1" not appearing as 3rd digit in any of the operands

out_dir = 'out/out-addition-bal-no5-3rddigit'
...
wandb_run_name = 'no5-3rddigit-add-bal'
...
start_527 = "FILE:data/addition_bal/no5_3rddigit_test.txt"
