...
out_dir = 'out-ft-shakespeare-addition-char-pad'
...
wandb_project = 'ft-shakespeare-addition-char'
wandb_run_name = 'mini-gpt-padded-shakepeare'
...
init_from = 'scratch'
ckpt_path_name = 'ckpt-shakespeare.pt'
eval_addition = False
