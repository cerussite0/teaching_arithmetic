...
init_from = 'resume'
resume_dir = f'out2/addition_reverse_longer_context/ckpt_10000_final.pt'

out_dir = f'out2_multidigit_ft_format/digit_{num_digit}/reverse_to_simple'
...
wandb_run_name = f'ft_{num_digit}digit_reverse_to_simple'
...
train_data_path = f'{num_digit}digit_5000.txt'
