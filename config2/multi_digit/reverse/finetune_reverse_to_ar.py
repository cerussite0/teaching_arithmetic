...
out_dir = f'out2_multidigit_ft_format/digit_{num_digit}/reverse_to_ar'
...
wandb_run_name = f'ft_{num_digit}digit_reverse_to_ar'
...
train_data_path = f'{num_digit}digit_2000.txt'
